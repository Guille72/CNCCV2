<div class="container marginTop2">
        ...
        <div class="row" id="AllMaison">
            <div class="col s12 m6 l4">
                <div class="card cardShadow">
                    ...
                    <div class="card-action">
                        <a class="colorCyan" href="maisonRousseau.php"><b>Voir plus d'information</b></a>
            ...
            <div class="col s12 m6 l4">
                <div class="card cardShadow">
                    <div class="card-image">
                        <img src="../lib/img/cnccv_prochainement.png">
                    </div>
                    <div class="card-content">
                    ...
                    <div class="card-action">
                        <a class="colorCyan" href="maisonChampion.php"><b>Voir plus d'information</b></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m6 l4">
                <div class="card cardShadow">
                    ...
                    <div class="card-action">
                        <a class="colorCyan" href="maisonPainleve.php"><b>Voir plus d'information</b></a>
                    </div>
                </div>
            </div>
