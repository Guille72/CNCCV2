...
use Cnccv\HouseBundle\Entity\Test;
...
class TestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tests = $em->getRepository('CnccvHouseBundle:Test')->findAll();
    ...
    {
        $test = new Test();
        $form = $this->createForm('Cnccv\HouseBundle\Form\TestType', $test);
    ...
    {
        $deleteForm = $this->createDeleteForm($test);
        $editForm = $this->createForm('Cnccv\HouseBundle\Form\TestType', $test);
