...
<nav class="nav-extended nav1 stickyNav" style="background-color: white" id="navbar">
    <div class="nav-wrapper">
        <a href="index.php" style="height: 200px; width: 200px"><img href="index.php" src="lib/img/logo_cnccv6_155x155.png" id="logo" class="brand-logo" style="height: 130px; width: auto;"></a>
    ...
    <div class="nav-content hide-on-med-and-down displayNScroll" id="cc">
        <ul class="centreETC tabs-transparent align_ul displayNScroll">
            <li class="tab li1 li"><a class="active colortext colortext1 waves-green" href="maisonRousseau.php"><h6>Chez Rousseau</h6></a></li>
            <li class="tab li"><a href="maisonChampion.php" class="colortext colortext1 waves-green"><h6>Chez Champion</h6></a></li>
            <li class="tab li li3"><a href="maisonPainleve.php" class="colortext colortext1 waves-green"><h6>Chez Painlevé</h6></a></li>
        </ul>
        <br>
    </div>
