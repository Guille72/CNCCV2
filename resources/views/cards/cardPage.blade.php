<div class="container marginTop2">
    ...
    <div class="row" id="AllMaison">
        <div class="col s12 m6 l4">
            <div class="card cardShadow">
                <div class="card-image">
                    <img src="{{asset('img/IMG_2739.JPG')}}">
                </div>
                <div class="card-content">
                    ...
                    <div class="row">
                        <div class="col s6 m8 l7">
                            <p><i style="margin-top: 15px" class="material-icons iconAlign">supervisor_account</i>
                                &nbsp; 4 personnes</p>
                        </div>
                ...
                <div class="card-action">
                    <a class="colorCyan" href="{{route('rousseau')}}"><b>Voir plus d'information</b></a>
                </div>
            </div>
        </div>
        ...
        <div class="col s12 m6 l4">
            <div class="card cardShadow">
                <div class="card-image">
                    <img src="{{asset('img/cnccv_prochainement.png')}}">
                </div>
                <div class="card-content">
                    ...
                    <p class="align "><i class="material-icons iconAlign"
                                         style="margin-top: 15px">supervisor_account</i>
                        &nbsp; 6
                        personnes
                    </p>
                </div>
                <div class="card-action">
                    <a class="colorCyan" href="{{route('champion')}}"><b>Voir plus d'information</b></a>
                </div>
            </div>
        </div>
        ...
        <div class="col s12 m6 l4">
            <div class="card cardShadow">
                ...
                <div class="card-action">
                    <a class="colorCyan" href="{{route('painLeve')}}"><b>Voir plus d'information</b></a>
                </div>
            </div>
        </div>
    </div>
