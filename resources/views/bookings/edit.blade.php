    ...
    <div class="row">
        <div class="container">
            ...
            <div class="form-group">
                ...
                {!! Form::date('arrivee', \Carbon\Carbon::class, ['class' => 'form-control', 'placeholder' => 'Arrivée']) !!}
            </div>

            <div class="form-group">
                {!! Form::label('depart', 'Départ') !!}
                {!! Form::date('depart', \Carbon\Carbon::class, ['class' => 'form-control', 'placeholder' => 'Départ']) !!}
            </div>
            ...
            {!! Form::open(['method' => 'PUT', 'route'=> ['bookingEdit', $booking]]) !!}
