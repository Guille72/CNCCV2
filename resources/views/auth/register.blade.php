            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="zip" class="col-md-4 col-form-label text-md-right">{{ __('Code postal') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="company" class="col-md-4 col-form-label text-md-right">{{ __('Entreprise (si professionnel)') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="siren" class="col-md-4 col-form-label text-md-right">{{ __('SIREN (si professionnel)') }}</label>

                            <div class="col-md-6">
                                <input id="siren" type="text" class="form-control{{ $errors->has('siren') ? ' is-invalid' : '' }}" name="siren" value="{{ old('siren') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="image" class="col-md-4 col-form-label text-md-right">{{ __('Carte d\'identité (PNG/JPG/PDF)') }}</label>
